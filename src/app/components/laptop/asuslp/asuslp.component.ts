...
@Component({
  selector: 'app-asuslp',
  templateUrl: './asuslp.component.html',
  styleUrls: ['./asuslp.component.css']
})
export class AsuslpComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    const questionId = '8'; // Replace with the desired ID
