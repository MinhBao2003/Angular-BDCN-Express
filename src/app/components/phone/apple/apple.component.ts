...
export class AppleComponent implements OnInit{
  ...
  constructor(private yourService: QuestionService,private phoneService: PhoneService,private route: ActivatedRoute,private laptopService: LaptopService,private tiviService: TiviService,private headphoneService: HeadphonesService,private clockService: ClockService){}
  ...
  ngOnInit(): void {
    ...
    const questionId = '1'; // Replace with the desired ID
  ...
  refreshPage(): void {
    if (this.shouldRefreshProducts) {
      ...
      this.phoneService.getPhoneIds([1, 2, 3]).subscribe(data => {
        this.allPhones = data;
