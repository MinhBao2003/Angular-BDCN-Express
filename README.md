** muốn chạy đc angular phải cài node js từ trang chủ của node js có thể cài node pb v21.7.3 hoặc mới nhất : https://nodejs.org/en/download/prebuilt-installer/current
