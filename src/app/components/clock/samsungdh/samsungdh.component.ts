...
@Component({
  selector: 'app-samsungdh',
  templateUrl: './samsungdh.component.html',
  styleUrls: ['./samsungdh.component.css']
})
export class SamsungdhComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    const questionId = '20'; // Replace with the desired ID
  ...
  filterPhones(): void {
    // Filter phones based on selected RAM
    this.donghos = this.allPhones.filter(phone => phone.clock === this.selectedday);
  }
